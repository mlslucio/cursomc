...
import com.silv.dto.ProdutoDTO;
import com.silv.resources.utils.Url;
import com.silv.services.ProdutoService;
...
public class ProdutoResource {
	...
	@GetMapping
	public ResponseEntity<Page<ProdutoDTO>> findPage(@RequestParam(value="nome", defaultValue="") String nome, @RequestParam(value="categorias", defaultValue="") String categorias,  @RequestParam(value="page", defaultValue="0") 
